...
function App() {
  ...
  const analyzeFood = async (e) => {
    ...
    try {
      ...
      setError(err.message || "Œÿ«Ì ‰«„‘Œ’ œ— œ—ŒÊ«”  API");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="app">
      ...
      <section className="hero">
        ...
        <p>
          „Ê«œ €–«ÌÌ —« Ê«—œ ò‰Ìœ  « «Ì„‰Ì° òÌ›Ì ° ¬·—é‰ùÂ« Ê ”ÿÕ —Ì”ò
          »Âù’Ê—  ÂÊ‘„‰œ »——”Ì ‘Êœ.
        </p>
      </section>
      ...
      <section className="card analysis-card">
        <div className="card-header">
          <div>
            ...
            <p>«ÿ·«⁄«  €–« Ê „Ê«œ  ‘òÌ·ùœÂ‰œÂ —« Ê«—œ ò‰Ìœ.</p>
          </div>
        ...
        <form onSubmit={analyzeFood}>
          ...
          <div className="form-group">
            <label htmlFor="ingredients">„Ê«œ  ‘òÌ·ùœÂ‰œÂ</label>
